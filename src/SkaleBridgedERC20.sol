...
contract SkaleBridgedERC20 is x402Token, AccessControl {
     ...
     * @dev this is done because burning ERC-20 on the sChain is not official burning since the tokens remain locked on the DepositBox contract
